...
(function ($) {
  ...
  $.fn.serializeJSON = function (options) {
		...
		$(this).find("input,select").each(function(index,ele){
		
			if(ele.name){
				result[ele.name] = $(ele).hasClass("number")?(ele.value?Number(ele.value):null):ele.value;
			}
		})
		return result;
  };
