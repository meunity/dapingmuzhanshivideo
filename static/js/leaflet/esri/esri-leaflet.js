    ...
    function(t, e) {
        ...
        function o(t, e, r, n) {
            var o = i(e),
                u = s(r, n),
                l = (t + "?" + o).length;
            if (l <= 2e3 && it.cors ? u.open("GET", t + "?" + o) : l > 2e3 && it.cors && (u.open("POST", t), u.setRequestHeader("Content-Type", "application/x-www-form-urlencoded")), "undefined" != typeof n && null !== n && "undefined" != typeof n.options && (u.timeout = n.options.timeout), l <= 2e3 && it.cors) u.send(null);
            else {
        ...
        function G(t) {
            ...
            if (i && i.attributionControl && s) {
                ...
                c.innerHTML = r, c.style.maxWidth = P(i), i.fire("attributionupdated", {
                    attribution: r
                })
            }
        }
        ...
        var ot = {
            ...
            ut = e.Class.extend({
                ...
                initialize: function(t) {
                    if (t.request && t.options ? (this._service = t, e.Util.setOptions(this, t.options)) : (e.Util.setOptions(this, t), this.options.url = R(t.url)), this.params = e.Util.extend({}, this.params || {}), this.setters) for (var i in this.setters) {
            ...
            lt = ut.extend({
                ...
                _setGeometry: function(t) {
                    return this.params.inSr = 4326, t instanceof e.LatLngBounds ? (this.params.geometry = I(t), void(this.params.geometryType = "esriGeometryEnvelope")) : (t.getLatLng && (t = t.getLatLng()), t instanceof e.LatLng && (t = {
                        ...
                        }), t instanceof e.GeoJSON && (t = t.getLayers()[0].feature.geometry, this.params.geometry = x(t), this.params.geometryType = O(t.type)), t.toGeoJSON && (t = t.toGeoJSON()), "Feature" === t.type && (t = t.geometry), "Point" === t.type || "LineString" === t.type || "Polygon" === t.type || "MultiPolygon" === t.type ? (this.params.geometry = x(t), void(this.params.geometryType = O(t.type))) : void F("invalid geometry passed to spatial query. Should be L.LatLng, L.LatLngBounds, L.Marker or a GeoJSON Point, Line, Polygon or MultiPolygon object"))
                }
            }),
            ht = ut.extend({
                setters: {
            ...
            bt = e.TileLayer.extend({
                ...
                initialize: function(t) {
                    t.url = R(t.url), t = e.Util.setOptions(this, t), this.tileUrl = t.url + "tile/{z}/{y}/{x}", this.service = j(t), this.service.addEventParent(this);
            ...
            St = xt.extend({
                ...
                initialize: function(t) {
                    t.url = R(t.url), this.service = Z(t), this.service.addEventParent(this), e.Util.setOptions(this, t)
                },
            ...
            At = xt.extend({
                ...
                initialize: function(t) {
                    t.url = R(t.url), this.service = j(t), this.service.addEventParent(this), (t.proxy || t.token) && "json" !== t.f && (t.f = "json"), e.Util.setOptions(this, t)
                },
        ...
        K.prototype.query = function(t) {
            ...
            for (var e, i, s = 0, r = this.values.length - 1; s <= r;) if (e = (s + r) / 2 | 0, i = this.values[Math.round(e)], +i.value < +t) s = e + 1;
            else {
        ...
        var It = Tt.extend({
                ...
                initialize: function(t) {
                    if (Tt.prototype.initialize.call(this, t), t.url = R(t.url), t = e.setOptions(this, t), this.service = W(t), this.service.addEventParent(this), "*" !== this.options.fields[0]) {
